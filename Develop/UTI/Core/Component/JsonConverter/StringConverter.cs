...
namespace UTI
{
    ...
    public static class StringConverter
    {
        ...
        public static bool Conver<T>(this string str)
        {
            ...
            {
                Log.Warning(("type_conver_error    ") + exp.Message + $"\n{exp.StackTrace}" + "  to  " + typeof(T).Name);
                return false;
            }
            return true;
        }
        ...
        private static object ConvertSimpleType(string value, Type destinationType, out bool result)
        {
            ...
            if (destinationType == typeof(Type))
            {
                ...
                {
                    Log.Warning(("type_cant_find  ") + str);
                    result = false;
                    return null;
                }
                return obj;
            ...
            {
                Log.Warning(("type_cant_conver  ") + value.ToString() + "!=" + destinationType);
                result = false;
                return null;
            }
            try
            ...
            {
                Log.Warning(("type_conver_error  ") + value?.ToString() + "=>" + destinationType.ToString());
                result = false;
                return null;
            }
            return returnValue;
